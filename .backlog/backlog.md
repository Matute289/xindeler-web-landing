...
| 005 | Pantalla de cuenta del jugador — sesión, seguridad (2FA) y nombre de usuario — **bloqueada por 007** | [005-cuenta-jugador-seguridad.md](tasks/005-cuenta-jugador-seguridad.md) | `[ ]` |
| 006 | Visor de personajes en la pantalla de cuenta — bloqueada, falta API en el game server (y también por 007) | [006-cuenta-jugador-personajes.md](tasks/006-cuenta-jugador-personajes.md) | `[ ]` |
| 007 | Sesión web autenticada — cómo la landing recuerda quién está logueado | [007-sesion-web-autenticada.md](tasks/007-sesion-web-autenticada.md) | `[ ]` |
