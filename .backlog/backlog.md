...
| 010 | El botón de descarga pasa a bajar el launcher (`xindeler-updater`), no el juego crudo | [010-download-button-launcher.md](tasks/010-download-button-launcher.md) | `[ ]` — bloqueado en `xindeler-web-api` (endpoint nuevo pendiente) |
